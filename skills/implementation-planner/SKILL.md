...
4. Record the implementation contract: acceptance-criterion references, design trade-offs, expected files and symbols, boundaries, required checks, and future posture.
...
11. List the approach, affected components, ordered steps, tests, risks, and any scope conflict.
12. Return the plan to the main agent for approval only when no material uncertainty remains.
